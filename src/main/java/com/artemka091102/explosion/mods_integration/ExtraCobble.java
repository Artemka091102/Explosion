...
public class ExtraCobble {
    ...
    public static void SetupCrackedDict() {
        ...
        putToCrackedDict("extracobble:mossy_andesite_cobble_wall", "extracobble:andesite_cobble_wall");
        putToCrackedDict("extracobble:mossy_andesite_cobble", "extracobble:andesite_cobble");
        putToCrackedDict("extracobble:mossy_andesite_cobble_slab", "extracobble:andesite_cobble_slab");
        putToCrackedDict("extracobble:mossy_andesite_cobble_stairs", "extracobble:andesite_cobble_stairs");
        //Diorite
        ...
        putToCrackedDict("extracobble:mossy_diorite_cobble_wall", "extracobble:diorite_cobble_wall");
        putToCrackedDict("extracobble:mossy_diorite_cobble", "extracobble:diorite_cobble");
